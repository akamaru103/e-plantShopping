...
import { addItem } from "./CartSlice"; // TASK 1

function ProductList({ onHomeClick }) {
    const dispatch = useDispatch();
    const [showCart, setShowCart] = useState(false);
    const [addedToCart, setAddedToCart] = useState({}); // TASK 1
        ...
        <div>
            <div className="navbar" style={styleObj}>
                ...
                <div style={styleObjUl}>
                    <div> <a href="#" className="navbar-title" onClick={(e) => handlePlantsClick(e)} style={styleA}>Plants</a></div>
                    {/* Fixed cart to show number of items */}
                ...
                <div className="product-grid">
                    ...
                    <div key={index}> {/* Unique key for each category div */}
                        ...
                        {category.plants.map((plant, plantIndex) => ( // Loop through each plant in the current category
                            ...
                            {/* Fixed add to cart button to be disabled on click */}
                            <button
